...
<script type="text/javascript">
	/* 자유게시판 저장 */
	function fboardAdd(){
		console.log('fboardAdd() 실행')
		var fboardAddForm = document.fboardForm;
		if(fboardAddForm.subject.value == "" || fboardAddForm.subject.value == null){
			alert("제목을 입력해주세요.");
			fboardAddForm.subject.focus();
			return false;
		} else if(fboardAddForm.content.value == "" || fboardAddForm.content.value == null){
			alert("내용을 입력해주세요.");
			fboardAddForm.content.focus();
			return false;
		}
		fboardAddForm.submit();
	}
</script>
<style type="text/css">
	.icons { /* 이름, 로그아웃 */
	...
	<div id="wrapper">
		<div id="main">
			<div class="inner">
				...
				<form action="freeboardInsertOK" name="fboardForm" method="post">
					<table style="width: 900px; margin-left: auto; margin-right: auto;">
						<tr align="center">
							<th colspan="2" >자유게시판 등록</th>
						</tr>
						<tr>
						...
						<tr class="actions" style="border-bottom: none;">
							<td colspan="2" align="right">
								<input class="button big" type="button" value="제출하기" onclick="fboardAdd()"/>
