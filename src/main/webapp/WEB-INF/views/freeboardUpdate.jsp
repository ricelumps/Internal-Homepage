...
<script type="text/javascript">
	...
	function fboardUpdate(){
		console.log('fboardUpdate() 실행')
		var fboardUpForm = document.fboardUp;
		if(fboardUpForm.subject.value == "" || fboardUpForm.subject.value == null){
			alert("제목을 입력해주세요.");
			fboardUpForm.subject.focus();
			return false;
		} else if(fboardUpForm.content.value == "" || fboardUpForm.content.value == null){
			alert("내용을 입력해주세요.");
			fboardUpForm.content.focus();
			return false;
		}
		fboardUpForm.submit();
	}
...
<body class="is-preload">
	<div id="wrapper">
		<div id="main">
			...
			<form action="freeboardUpdateOK" name="fboardUp" method="post">
				<table style="width: 900px; margin-left: auto; margin-right: auto;">
					<tr>
						<th colspan="2">자유게시글 수정</th>
					</tr>
					<tr>
						...
						<td>
							<input id="subject" type="text" name="subject" value="${fo.subject}"/>
						</td>
					</tr>
					<tr>
						...
						<td>
							<textarea id="content" rows="10" name="content" style="resize: none;">${fo.content}</textarea>
						</td>
					</tr>
					<tr class="actions" style="border-bottom: none;">
						<td colspan="2" align="center">
							<div>
								<input class="button big" type="button" value="수정하기" onclick="fboardUpdate()"/>
								...
								<input class="button big" type="button" value="목록보기" 
									onclick="location.href='freeboardList?currentPage=${currentPage}'"/>
							</div>
						</td>
					</tr>
				</table>
