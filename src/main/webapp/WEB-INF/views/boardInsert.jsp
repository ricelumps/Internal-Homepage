...
<script type="text/javascript">
	/* 공지 저장 */
	function boardAdd(){
		console.log('boardAdd() 실행')
		var boardAddForm = document.boardForm;
		if(boardAddForm.gubun.value == "" || boardAddForm.gubun.value == null){
			alert("공지 종류를 선택해주세요.");
			return false;
		} else if(boardAddForm.subject.value == "" || boardAddForm.subject.value == null){
			alert("제목을 입력해주세요.");
			boardAddForm.subject.focus();
			return false;
		} else if(boardAddForm.content.value == "" || boardAddForm.content.value == null){
			alert("내용을 입력해주세요.");
			boardAddForm.content.focus();
			return false;
		}
		boardAddForm.submit();
	}
	...
	<div id="wrapper">
		<div id="main">
			<div class="inner">
				...
				<form action="boardInsertOK" name="boardForm" method="post">
					<table style="width: 900px; margin-left: auto; margin-right: auto;">
						...
						<tr class="actions" style="border-bottom: none;">
							<td colspan="2" align="right">
								<input class="button big" type="button" value="등록하기" onclick="boardAdd()"/>
