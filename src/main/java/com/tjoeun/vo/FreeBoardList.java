...
public class FreeBoardList {
	...
	private ArrayList<FreeBoardVO> list3 = new ArrayList<FreeBoardVO>();
	...
	public ArrayList<FreeBoardVO> getList3() {
		return list3;
	}
	public void setList3(ArrayList<FreeBoardVO> list3) {
		this.list3 = list3;
	}
	...
	public String toString() {
		return "BoardList [list3=" + list3 + ", pageSize=" + pageSize + ", totalCount=" + totalCount + 
